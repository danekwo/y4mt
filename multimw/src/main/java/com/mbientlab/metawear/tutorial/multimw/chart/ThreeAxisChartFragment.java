...
package com.mbientlab.metawear.tutorial.multimw.chart;
...
public abstract class ThreeAxisChartFragment extends SensorFragment {
    ...
    protected String saveData() {
        ...
        String filename = String.format(Locale.US, "%s_%tY%<tm%<td-%<tH%<tM%<tS%<tL.csv", sensorResId, Calendar.getInstance());
